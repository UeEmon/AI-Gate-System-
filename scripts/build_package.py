...
FILES=['app.py','web.py','events.py','evidence.py','registry_csv.py','mail_delivery.py','requirements.txt','Dockerfile','README.md','THIRD_PARTY_NOTICES.md','LICENSE-PROPOSAL.md','.dockerignore']
