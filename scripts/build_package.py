...
FILES=['app.py','web.py','runtime_profile.py','events.py','evidence.py','registry_csv.py','mail_delivery.py','ocr_learning.py','ocr_train.py','ocr_backends.py','accuracy_benchmark.py','vision_train.py','plate_geometry.py','plate_rules.py','requirements.txt','Dockerfile','README.md','THIRD_PARTY_NOTICES.md','LICENSE-PROPOSAL.md','.dockerignore']
DIRS=['templates','static','onprem','scripts','licenses','tests','deploy','examples','training']
